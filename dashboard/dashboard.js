            ...
            ${examples.map((ex, index) => {
              ...
              if (index === 0 && hasSource) {
                try {
                  ...
                  html += `<br><a href="${word.sourceUrl}" target="_blank" class="source-link" title="View original source">📎 ${domain}</a>`;
                } catch (e) {
  ...
  if (examples.length > 0) {
    previewExamples.innerHTML = examples.map((example, index) => {
      ...
      if (index === 0 && wordData.sourceUrl && wordData.sourceSentence) {
        html += `<br><a href="${wordData.sourceUrl}" target="_blank" class="source-link">📎 View source</a>`;
      }
